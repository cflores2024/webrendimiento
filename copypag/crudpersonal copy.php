    ...
    if (isset($_GET['idpersona']))
    {
      ...
      if (isset($_GET['btn']))
      {
        ...
        switch ($_GET['btn'])
        {
          ...
          case "ActPass"://SE ACTUALIZA EL PASSWORD DEL PERSONAL
                          ...
                          {
                            $txtpass=password_hash(trim($txtpass), PASSWORD_DEFAULT);
      ...
      if ($accion=="OKELI")
      {
          $sql = "SELECT a.`urlfoto`,a.`nombrecortousu`,a.`apellido`,a.`nombre`,a.`nrosocio`,a.`dni`,a.`fnacimiento`,a.`domicilio`,a.`tel`,a.`emailusuario`,a.`pass`,b.`iddisciplina`,c.`disciplina`,a.aptoingreso,a.finiapto,a.ffinapto
                  ...
                  WHERE a.`accion`='B' AND a.idpersona=". $idsocio;     
          $accion="OK";
      }
      else
      {
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <form action="" method="get">
                    ...
                    <input type="hidden" id="accionperfil" name="accion" value="<?php echo $accion; ?>">
                                            ...
                                            elseif ($accion=="ERROR2") 
                                              {
                                                ...
                                                echo "<button id='btndatos' name='btn' value='ActDatos' type='submit' class='btn btn-primary'>Actualizar Datos</button>";
                                              }
                            break;
                            case "EliSoc":
                                          if ($accion=="OK") echo "Acción realizada satisfacoriamente!!!!"; 
                                          elseif ($accion=="ERROR2") 
                                            {
                                              echo "<p>Error en la acción!!!!</p>"; 
                                              echo "<button id='btneli' name='btn' value='ActDatos' type='submit' class='btn btn-primary'>Actualizar Datos</button>";
                                            }
                            break;
                            default:
                                          echo "<button id='btndefa' name='btn' value='ActDatos' type='submit' class='btn btn-primary'>Actualizar Datos</button>";
                          }
                        }
                        else 
                        {
                          if ($accion=="B") echo "<button id='btneli' name='btn' value='EliSoc' type='submit' class='btn btn-primary'>Eliminar Persona</button>";
                          else echo "<button id='btnactd' name='btn' value='ActDatos' type='submit' class='btn btn-primary'>Actualizar Datos</button>";
                        }
