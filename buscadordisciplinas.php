          ...
          <div class="card">
            <div class="card-body">
              ...
              <?php
                  ...
                  $sql = "SELECT a.`iddisciplina`,a.`disciplina`,a.`observacion`
                          FROM disciplinas a
                          WHERE a.`accion`!='B'
                    ...
                    while($row = mysqli_fetch_array($result))
                    {
                      echo "
                            <tr>
                              ...
                              <td><a href='cruddisciplina.php?iddisciplina=".$row['iddisciplina']."&accion=M'><img src='./assets/img/buscar.png' alt='Ver registro' srcset=''></a></td>
