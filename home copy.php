      ...
      <!-- TOTAL DE ORDENES X MES -->
        <div class="col-lg-3">
          ...
          <div class="card info-card sales-card">
              <?php
                ...
                */  
                 $sql = "SELECT COUNT(a.`numorden`) AS act
                         FROM numeroorden a
                         WHERE a.`accion`!='B' AND a.estado!='S' AND a.`fecha` BETWEEN '".$txtfini."' AND '".$txtffin."';";
            ...
            <div class="card-body">
              <h5 class="card-title"><a href="homexfiltros.php?op=TO">Total Ordenes</a><span>| <?php echo obtenermes('C',0) ." ". $anioC; ?></span></h5>
      ...
      <!-- ORDENES DEMORAS-->
        <div class="col-lg-3">
          ...
          <div class="card info-card sales-card">
            ...
            <div class="card-body">
              <h5 class="card-title"><a href="homexfiltros.php?op=DE">Demoradas</a> <span>| <?php echo obtenermes('C',0) ." ". $anioC; ?> </span></h5>
      ...
      <!-- ORDENES TERMINADAS-->    
        <div class="col-lg-3">
          ...
          <div class="card info-card sales-card">
            ...
            <div class="card-body">
              <h5 class="card-title"><a href="homexfiltros.php?op=TE">Terminadas</a> <span>| <?php echo obtenermes('C',0) ." ". $anioC; ?></span></h5>
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <?php    
            ...
            echo "<div class='card'>
                    <div class='card-body'>
                      <h5 class='card-title'><a href='homexfiltros.php?op=FM'>Total Ordenes Finalizadas x Mecanico - ". obtenermes('L',0) ." ". $anioL ."</a></h5>
