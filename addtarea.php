...
<?php
  ...
  {  
    ...
    //SE RECUPERAN LOS DATOS DE LA NUEVA TAREA
    if (isset($_GET['txttarea']))
    {
      ...
      $sql="INSERT INTO tareas (descripciontarea,tiempotarea,accion,idempleadoaccion,fechaaccion)
            VALUES (?,?,?,?,?);";

      $con=conectar();
      $sentencia=mysqli_prepare($con,$sql);//preparo consulta
      mysqli_stmt_bind_param($sentencia,'sssss',$txttarea,$txttiempo,$accion,$id,$fechaaccion);
      ...
      if ($resp)  
      {
        ...
        $sql = "SELECT a.`idtarea` FROM tareas a WHERE a.`accion`!='B' AND a.descripciontarea='".$txttarea."';";
          ...
          <div class="card">
            <div class="card-body">
                <h5 class="card-title">Nueva Tarea</h5>
                  <!-- Profile Edit Form -->
                  <form action="" method="GET" id="form_crear_cuenta_alumno">
                    <div class="row mb-3">
                      <label for="txttarea" class="col-md-4 col-lg-3 col-form-label">Tarea Descripción</label>
                      <div class="col-md-8 col-lg-9">
                        <input name="txttarea" type="text" class="form-control" id="txttarea" placeholder="Ingrese descripción tarea" <?php if (strlen($txttarea)>0) echo "value='". $txttarea ."'"; ?>>
                      </div>
                    </div>

                    <div class="row mb-3">
                      <label for="txttiempo" class="col-md-4 col-lg-3 col-form-label">Duración tarea</label>
                      <div class="col-md-8 col-lg-9">
                        <input name="txttiempo" type="time" class="form-control" id="txttiempo" placeholder="Ingrese duración tarea" <?php if (strlen($txttiempo)>0) echo "value='".$txttiempo ."'" ?>>
                      </div>
                    </div>
                    ...
                    <div class="text-center">
                      <?php 
                        ...
                        elseif ($accion=="ERROR") echo "Error en la acción!!!!"; 
                            else echo  "<button type='submit' class='btn btn-primary'>Guardar Tarea/Tiempo</button>";
