<?php  
    ...
    if ((isset($_GET['fini']))&&(isset($_GET['ffin']))&&(isset($_GET['num']))&&(isset($_GET['titulo']))&&(isset($_GET['emp'])))
    {
        ...
        //CONSULTA QUE TRAE LISTADO DE ORDENES Y SITUACIONES EN LAS QUE SE ENCUENTRAN
            ...
            else
            {
                while($row = mysqli_fetch_array($result))
                {
                    ...
                    $fila=$fila."<tr>
                                    <th scope='row'>".$i."</th>
                                    <td><a href='#' onclick='ampliardetallemecanico(".$row['numorden'].")'>#".$row['numorden']."</a></td>
            ...
            if ($fila!="") $ttareas= $encabezado."".$fila."".$pie;
            else $ttareas= $encabezado."<tr><td style='text-align: center;' colspan='10'>Sin datos para mostrar</td></tr>".$pie;
                    ...
                    <div class='col-lg-12'>
                        <div class='card'>
                            <div class='card-body'>
                                <br>
                                    <span id='lsdetameca'>
                                        <div style='text-align: center;'>Seleccione un número de orden para ampliar en detalles!!!</div>
                                    </span>
                                </br>
                            </div>
                        </div>
            ...
            while($row = mysqli_fetch_array($result))
            {
                if (strlen($row["idempleado"])>0)
                {
                    ...
                    $filameca=$filameca."<tr class='fila' style='text-align: center;'>
                                            <th scope='row'><a href='#' onclick='vercontenidotarea(".$row['numorden'].",".$idusuario.",".$row['idempleado'].")'>#".$row['mecanico']."</a></th>
                                            <td>
        ...
        if ($filameca!="") $tmecanicos=$encabezadomeca."".$filameca."".$piemeca;
        else $tmecanicos=$encabezadomeca."<tr><td style='text-align: center;' colspan='7'>Sin datos para mostrar</td></tr>".$piemeca;

        //FIN TABLA QUE MUESTRA TOTALES GENERALES DE LA ANTERIOR TABLA

        echo $tmecanicos ." <span id='lsdetameca'>
                            <div class='row'>
                                <div class='col-lg-12'>
                                    <div class='card'>
                                        <div class='card-body'>
                                            <br>
                                                <div style='text-align: center;'>Seleccione un mecanico para ampliar en detalles!!!</div>
                                            </br>
                                        </div>
                                    </div>
                                </div>
