        ...
        $tablas="<div class='card'>
                    ...
                    <div class='card-body'>
                        ...
                        <div class='d-flex align-items-start'>
                            ...
                            <button class='nav-link active' id='v-pills-home-tab' data-bs-toggle='pill' data-bs-target='#v-pills-home' type='button' role='tab' aria-controls='v-pills-home' aria-selected='true' onclick='acciondivdetallemeca()'>General</button>
                            <button class='nav-link' id='v-pills-profile-tab' data-bs-toggle='pill' data-bs-target='#v-pills-profile' type='button' role='tab' aria-controls='v-pills-profile' aria-selected='false' onclick='acciondivdetallemeca()'>Por Mecanico</button>
                            </div>
                ...
                <span id='lsdetallemeca'>
                    <div class='card' id='lsdetameca' style='display:none;'>
                        <div class='card-body'>
                            Para ampliar detalles de las tareas realizadas por un mecanico. Seleccione alguno del listado!!!
                        </div>
                    </div>
                </span>
                ";
